...
//More info on NanoAOD is located here: https://twiki.cern.ch/twiki/bin/view/CMSPublic/WorkBookNanoAOD
void loop_plain(TTreeReader& reader) {
    ...
    //As usual in C++ ROOT, we have to predefine every branch and this can get annoying, which is why I've developed a simple wrapper
