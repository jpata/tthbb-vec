...
#include <iostream> 
#include <iomanip> 
#include "Parameters_sm__hgg_plugin_full.h"

// Initialize static instance
Parameters_sm__hgg_plugin_full * Parameters_sm__hgg_plugin_full::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm__hgg_plugin_full * Parameters_sm__hgg_plugin_full::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm__hgg_plugin_full(); 

  return instance; 
}

void Parameters_sm__hgg_plugin_full::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
  ...
  mdl_WH1 = slha.get_block_entry("decay", 9000006, 5.753088e-03); 
  ...
  mdl_MP = slha.get_block_entry("mass", 9000006, 1.200000e+02); 
...
void Parameters_sm__hgg_plugin_full::setIndependentCouplings()
{
...
void Parameters_sm__hgg_plugin_full::setDependentParameters()
{
...
void Parameters_sm__hgg_plugin_full::setDependentCouplings()
{
  GC_13__1 = -(mdl_complexi * mdl_GH); 
}

// Routines for printing out parameters
void Parameters_sm__hgg_plugin_full::printIndependentParameters()
{
  cout <<  "sm__hgg_plugin_full model parameters independent of event kinematics:" <<
      endl;
...
void Parameters_sm__hgg_plugin_full::printIndependentCouplings()
{
  cout <<  "sm__hgg_plugin_full model couplings independent of event kinematics:" <<
      endl;
...
void Parameters_sm__hgg_plugin_full::printDependentParameters()
{
  cout <<  "sm__hgg_plugin_full model parameters dependent on event kinematics:" <<
      endl;
...
void Parameters_sm__hgg_plugin_full::printDependentCouplings()
{
  cout <<  "sm__hgg_plugin_full model couplings dependent on event kinematics:"
      << endl;
  cout << setw(20) <<  "GC_13__1 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_13__1 << endl;
}
