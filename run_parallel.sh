...
find /fast/tmp1/jobs/dyjets_ll/ -name "*.root" | xargs hadd /fast/tmp1/dyjets_ll.root
...
find /fast/tmp1/jobs/ggh_hmumu/ -name "*.root" | xargs hadd /fast/tmp1/ggh_hmumu.root
./bin/df /fast/tmp1/ggh_hmumu out_ggh.root
